...
import 'package:scores_data/src/data_sources/the_sports_db_scores_data_source.dart';
import 'package:scores_domain/scores_domain.dart';

/// Overrides à appliquer dans la composition : branche les interfaces du common
/// domain sur les sources de données. Le reste de l'app ignore tout de ce choix.
